  ...
  document.getElementById('detBody').innerHTML =
    ...
    + (c.tipo === 'estudio'
        ? '<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px">'
            + '<button onclick="markVisited(' + id + ',&quot;no_encontrado&quot;)" style="text-align:left;padding:12px;border-radius:14px;border:1px solid rgba(192,57,43,.25);background:#fdf0f0;cursor:pointer;display:flex;flex-direction:column;gap:6px">'
              + '<div style="display:flex;align-items:center;justify-content:space-between">'
                + '<div style="width:28px;height:28px;border-radius:9px;background:rgba(192,57,43,.12);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="14" height="14" fill="#c0392b"><path d="M15.5 14h-.79l-.28-.27A6.47 6.47 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/></svg></div>'
                + '<svg viewBox="0 0 24 24" width="14" height="14" fill="#c0392b" style="opacity:.5"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>'
              + '</div>'
              + '<div style="font-size:13px;font-weight:800;color:#c0392b">No encontrado</div>'
              + '<div style="font-size:10.5px;color:#c0392b;opacity:.75;line-height:1.3">Marcar como no encontrado en esta visita</div>'
            + '</button>'
            + '<button onclick="markVisited(' + id + ',&quot;visitado&quot;)" style="text-align:left;padding:12px;border-radius:14px;border:1px solid rgba(30,126,52,.25);background:#edf7ef;cursor:pointer;display:flex;flex-direction:column;gap:6px">'
              + '<div style="display:flex;align-items:center;justify-content:space-between">'
                + '<div style="width:28px;height:28px;border-radius:9px;background:rgba(30,126,52,.12);display:flex;align-items:center;justify-content:center"><svg viewBox="0 0 24 24" width="14" height="14" fill="#1e7e34"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg></div>'
                + '<svg viewBox="0 0 24 24" width="14" height="14" fill="#1e7e34" style="opacity:.5"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>'
              + '</div>'
              + '<div style="font-size:13px;font-weight:800;color:#1e7e34">Visitado</div>'
              + '<div style="font-size:10.5px;color:#1e7e34;opacity:.75;line-height:1.3">Marcar como visitado exitosamente</div>'
            + '</button>'
          + '</div>'
